					...
					<div class="card-body">
						...
						<table class="table table-striped">
							...
							<tbody>
								...
								HospitalDAO hospDAO2 = new HospitalDAO(DBConnection.getConn());
								...
								<tr>
									...
									<td><% Hospital hosp = hospDAO2.getHospitalById(doctorLst.getHospitalId()); %><%= hosp != null ? hosp.getName() : "N/A" %></td>
