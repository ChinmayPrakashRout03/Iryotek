<nav class="navbar navbar-expand-lg navbar-dark bg-danger">
	<div class="container-fluid">
		<a class="navbar-brand" href="index.jsp"><img src="../img/logo.png" alt="Iryotek Logo" style="height: 30px; margin-right: 8px; vertical-align: middle;"> Iryotek</a>
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			...
			<ul class="navbar-nav me-auto mb-2 mb-lg-0">
				...
				<li class="nav-item"><a class="nav-link active"
					aria-current="page" href="hospital.jsp"><i
						class="fa-solid fa-hospital"></i> HOSPITAL</a></li>
				<li class="nav-item"><a class="nav-link active"
					aria-current="page" href="view_hospital.jsp"><i
						class="fa-solid fa-list"></i> VIEW HOSPITAL</a></li>
			</ul>
