...
public class DoctorDAO {
	...
	public boolean registerDoctor(Doctor doctor) {
		...
		try {
			...
			String sql = "insert into doctor(fullName,dateOfBirth,qualification,specialist,email,phone,password,hospitalId) values(?,?,?,?,?,?,?,?)";
	...
	public List<Doctor> getAllDoctor() {
		...
		try {
			...
			while (resultSet.next()) {
				...
				doctor.setHospitalId(resultSet.getInt("hospitalId"));
				docList.add(doctor);
			}
	...
	public boolean updateDoctor(Doctor doctor) {
		...
		try {
			...
			String sql = "update doctor set fullName=?,dateOfBirth=?,qualification=?,specialist=?,email=?,phone=?,password=?,hospitalId=? where id=?";
	...
	public List<Doctor> getDoctorsByHospitalId(int hospitalId) {
		...
		try {
			...
			String sql = "select * from doctor where hospitalId=? order by fullName";
			PreparedStatement pstmt = this.conn.prepareStatement(sql);
